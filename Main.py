...
def def_user_date():
    ...
    try:
        with open("Reservation_List.txt", "r") as file:
    ...
    if start_func == 1:
        ...
        while rsv_session == 1:
            try:
                ...
                rsv_list.append(f"Slot {def_user_session()}")
                rsv_session = 0
                rsv_name = 1
        ...
        if rsv_add_pax == 0:
            ...
            with open("Reservation_List.txt", "a") as file:
        ...
        while can_date == 1:
            try:
                print(f"\n============================================\n"
                      f"                Reservation date"
                      f"\n============================================")
                can_user_date = input("What was your reservation date? [YYYY-MM-DD]:")  # Asks for user's reservation date
                datetime.strptime(can_user_date, "%Y-%m-%d").date()  # Formats the user's date into the appropriate format
            ...
            while can_name == 1:
                ...
                with open("Reservation_List.txt", "w") as file:
                    for reservation in can_list:
            ...
            while upd_date == 1:
                try:
                    print(f"\n============================================\n"
                          f"                Reservation date"
                          f"\n============================================")
                    upd_user_date = input("What was your reservation date? [YYYY-MM-DD]:")  # Ask for user's reservation date
                    datetime.strptime(upd_user_date, "%Y-%m-%d").date()  # Formats the user's input date into appropriate format
                ...
                # Display this error message ifuser's date is invalid
                except ValueError:
                    print("\n## Incorrect date format, please try again! ##\n")
